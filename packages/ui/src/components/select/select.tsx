...
import { Check, TrianglesMini } from "@grupoamerico/icons"
import { cva } from "cva"
  ...
  (
    ...
    <RadixSelect.Portal>
      <RadixSelect.Content
        ref={ref}
        className={clx(
          "bg-ui-bg-component text-ui-fg-base shadow-elevation-flyout relative z-[100] max-h-[200px] min-w-[var(--radix-select-trigger-width)] overflow-hidden rounded-lg",
