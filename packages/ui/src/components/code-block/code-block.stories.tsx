...
const snippets = [
  ...
  {
    label: "Americo JS Client",
    language: "jsx",
    code: `// Install the JS Client in your storefront project: @americojs/americo-js\n\nimport Americo from "@americojs/americo-js"\n\nconst americo = new Americo({ publishableApiKey: "YOUR_API_KEY"})\nconst product = await americo.products.retrieve("PRODUCT_ID")\nconsole.log(product.id)`,
  },
  {
    label: "Americo React",
    language: "tsx",
    code: `// Install the React SDK and required dependencies in your storefront project:\n// americo-react @tanstack/react-query @americojs/americo\n\nimport { useProduct } from "americo-react"\n\nconst { product } = useProduct("PRODUCT_ID")\nconsole.log(product.id)`,
  },
]
