...
import { CheckMini, ChevronRightMini, EllipseMiniSolid } from "@grupoamerico/icons"
...
>(({ className, collisionPadding = 8, ...props }, ref) => (
  <RadixDropdownMenu.Portal>
    <RadixDropdownMenu.SubContent
      ...
      className={clx(
        "bg-ui-bg-component text-ui-fg-base shadow-elevation-flyout z-[100] max-h-[var(--radix-popper-available-height)] min-w-[220px] overflow-hidden rounded-lg p-1",
