// Complete preset for showcase - based on @americojs/ui-preset
      ...
      ui: {
        tag: {
          neutral: {
            ...
            bg: { hover: { DEFAULT: "var(--tag-neutral-bg-hover)" }, DEFAULT: "var(--tag-neutral-bg)" },
          },
          red: {
            text: { DEFAULT: "var(--tag-red-text)" },
            bg: { DEFAULT: "var(--tag-red-bg)", hover: { DEFAULT: "var(--tag-red-bg-hover)" } },
          ...
          blue: {
            ...
            bg: { DEFAULT: "var(--tag-blue-bg)", hover: { DEFAULT: "var(--tag-blue-bg-hover)" } },
          ...
          orange: {
            ...
            bg: { hover: { DEFAULT: "var(--tag-orange-bg-hover)" }, DEFAULT: "var(--tag-orange-bg)" },
          },
          green: {
            icon: { DEFAULT: "var(--tag-green-icon)" },
            border: { DEFAULT: "var(--tag-green-border)" },
            text: { DEFAULT: "var(--tag-green-text)" },
            bg: { hover: { DEFAULT: "var(--tag-green-bg-hover)" }, DEFAULT: "var(--tag-green-bg)" },
          },
          purple: {
            bg: { DEFAULT: "var(--tag-purple-bg)", hover: { DEFAULT: "var(--tag-purple-bg-hover)" } },
        ...
        bg: {
          switch: { off: { hover: { DEFAULT: "var(--bg-switch-off-hover)" }, DEFAULT: "var(--bg-switch-off)" } },
          subtle: { hover: { DEFAULT: "var(--bg-subtle-hover)" }, DEFAULT: "var(--bg-subtle)", pressed: { DEFAULT: "var(--bg-subtle-pressed)" } },
          field: { component: { hover: { DEFAULT: "var(--bg-field-component-hover)" }, DEFAULT: "var(--bg-field-component)" }, DEFAULT: "var(--bg-field)", hover: { DEFAULT: "var(--bg-field-hover)" } },
          base: { pressed: { DEFAULT: "var(--bg-base-pressed)" }, hover: { DEFAULT: "var(--bg-base-hover)" }, DEFAULT: "var(--bg-base)" },
          highlight: { DEFAULT: "var(--bg-highlight)", hover: { DEFAULT: "var(--bg-highlight-hover)" } },
          component: { pressed: { DEFAULT: "var(--bg-component-pressed)" }, DEFAULT: "var(--bg-component)", hover: { DEFAULT: "var(--bg-component-hover)" } },
          interactive: { DEFAULT: "var(--bg-interactive)" },
          disabled: { DEFAULT: "var(--bg-disabled)" },
          overlay: { DEFAULT: "var(--bg-overlay)" },
        },
        border: {
          menu: { bot: { DEFAULT: "var(--border-menu-bot)" }, top: { DEFAULT: "var(--border-menu-top)" } },
        ...
        contrast: {
          fg: { primary: { DEFAULT: "var(--contrast-fg-primary)" }, secondary: { DEFAULT: "var(--contrast-fg-secondary)" } },
          bg: { base: { pressed: { DEFAULT: "var(--contrast-bg-base-pressed)" }, DEFAULT: "var(--contrast-bg-base)", hover: { DEFAULT: "var(--contrast-bg-base-hover)" } }, subtle: { DEFAULT: "var(--contrast-bg-subtle)" } },
          border: { base: { DEFAULT: "var(--contrast-border-base)" }, bot: { DEFAULT: "var(--contrast-border-bot)" }, top: { DEFAULT: "var(--contrast-border-top)" } },
        },
        button: {
          inverted: { pressed: { DEFAULT: "var(--button-inverted-pressed)" }, hover: { DEFAULT: "var(--button-inverted-hover)" }, DEFAULT: "var(--button-inverted)" },
          transparent: { DEFAULT: "var(--button-transparent)", hover: { DEFAULT: "var(--button-transparent-hover)" }, pressed: { DEFAULT: "var(--button-transparent-pressed)" } },
          danger: { pressed: { DEFAULT: "var(--button-danger-pressed)" }, DEFAULT: "var(--button-danger)", hover: { DEFAULT: "var(--button-danger-hover)" } },
          neutral: { DEFAULT: "var(--button-neutral)", hover: { DEFAULT: "var(--button-neutral-hover)" }, pressed: { DEFAULT: "var(--button-neutral-pressed)" } },
        },
        fg: {
          on: { color: { DEFAULT: "var(--fg-on-color)" }, inverted: { DEFAULT: "var(--fg-on-inverted)" } },
          interactive: { hover: { DEFAULT: "var(--fg-interactive-hover)" }, DEFAULT: "var(--fg-interactive)" },
        ...
        alpha: { 250: { DEFAULT: "var(--alpha-250)" }, 400: { DEFAULT: "var(--alpha-400)" } },
      },
    },
    boxShadow: {
  ...
  function ({ addBase, addComponents, config }) {
    ...
    if (darkMode === "class") {
      addBase({
        ...
        '[data-mode="dark"]': colors.dark,
      })
    }

    // Typography classes
    addComponents({
      ".txt-compact-xlarge-plus": { fontSize: "1.125rem", lineHeight: "1.5rem", fontWeight: "500" },
      ".txt-compact-xlarge": { fontSize: "1.125rem", lineHeight: "1.5rem", fontWeight: "400" },
      ".txt-compact-large-plus": { fontSize: "1rem", lineHeight: "1.375rem", fontWeight: "500" },
      ".txt-compact-large": { fontSize: "1rem", lineHeight: "1.375rem", fontWeight: "400" },
      ".txt-compact-medium-plus": { fontSize: "0.875rem", lineHeight: "1.25rem", fontWeight: "500" },
      ".txt-compact-medium": { fontSize: "0.875rem", lineHeight: "1.25rem", fontWeight: "400" },
      ".txt-compact-small-plus": { fontSize: "0.8125rem", lineHeight: "1.125rem", fontWeight: "500" },
      ".txt-compact-small": { fontSize: "0.8125rem", lineHeight: "1.125rem", fontWeight: "400" },
      ".txt-compact-xsmall-plus": { fontSize: "0.75rem", lineHeight: "1rem", fontWeight: "500" },
      ".txt-compact-xsmall": { fontSize: "0.75rem", lineHeight: "1rem", fontWeight: "400" },
      ".txt-xlarge-plus": { fontSize: "1.125rem", lineHeight: "1.75rem", fontWeight: "500" },
      ".txt-xlarge": { fontSize: "1.125rem", lineHeight: "1.75rem", fontWeight: "400" },
      ".txt-large-plus": { fontSize: "1rem", lineHeight: "1.5rem", fontWeight: "500" },
      ".txt-large": { fontSize: "1rem", lineHeight: "1.5rem", fontWeight: "400" },
      ".txt-medium-plus": { fontSize: "0.875rem", lineHeight: "1.5rem", fontWeight: "500" },
      ".txt-medium": { fontSize: "0.875rem", lineHeight: "1.5rem", fontWeight: "400" },
      ".txt-small-plus": { fontSize: "0.8125rem", lineHeight: "1.375rem", fontWeight: "500" },
      ".txt-small": { fontSize: "0.8125rem", lineHeight: "1.375rem", fontWeight: "400" },
      ".txt-xsmall-plus": { fontSize: "0.75rem", lineHeight: "1.25rem", fontWeight: "500" },
      ".txt-xsmall": { fontSize: "0.75rem", lineHeight: "1.25rem", fontWeight: "400" },
      ".h1-core": { fontSize: "1.125rem", lineHeight: "1.5rem", fontWeight: "500" },
      ".h2-core": { fontSize: "1rem", lineHeight: "1.375rem", fontWeight: "500" },
      ".h3-core": { fontSize: "0.875rem", lineHeight: "1.25rem", fontWeight: "500" },
    })
  },
  { theme }
)
...
module.exports = {
  content: [],
  plugins: [americoUiPlugin, require("tailwindcss-animate")],
}
